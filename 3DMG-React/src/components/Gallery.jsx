...
const Gallery = () => {
  return (
    <>
      <div className="Slider">I AM SLIDER</div>
      ...
      <div className="TextTo3DContentMainDiv">
        <div className="TextTo3DContent">
          <div className="TextTo3DElement1">
            <img src={pig} alt="Pig's Image" style={{ width: '20vw', height: '40vh' ,borderRadius: '10px'}} />
          </div>
          <div className="TextTo3DElement2">
            <img src={amongus} alt="Pig's Image" style={{ width: '20vw', height: '40vh',borderRadius: '10px' }}/>
          </div>
          <div className="TextTo3DElement3">
            <img src={fish} alt="Pig's Image" style={{ width: '20vw', height: '40vh' ,borderRadius: '10px'}}/>
          </div>
          <div className="TextTo3DElement4">
            <img src={laptop} alt="Pig's Image" style={{ width: '20vw', height: '40vh',borderRadius: '10px' }}/>
          </div>
          <div className="TextTo3DElement5">
            <img src={penguin} alt="Pig's Image" style={{ width: '20vw', height: '40vh',borderRadius: '10px' }}/>
          </div>
          <div className="TextTo3DElement6">
            <img src={ring} alt="Pig's Image" style={{ width: '20vw', height: '40vh' ,borderRadius: '10px'}}/>
          </div>
          <div className="TextTo3DElement7">
            <img src={sofa} alt="Pig's Image" style={{ width: '20vw', height: '40vh' ,borderRadius: '10px'}}/>
          </div>
          <div className="TextTo3DElement8">
            <img src={trophy} alt="Pig's Image" style={{ width: '20vw', height: '40vh' ,borderRadius: '10px'}}/>
          </div>
